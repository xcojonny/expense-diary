...
from app.api.v1 import admin, analytics, auth, categories, groups, health, me, receipts, tokens
...
def create_app() -> FastAPI:
    ...
    app.include_router(admin.router, prefix=api, dependencies=[Depends(require_instance_admin)])
