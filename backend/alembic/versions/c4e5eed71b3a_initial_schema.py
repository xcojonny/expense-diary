...
Revision ID: c4e5eed71b3a
Revises: 
Create Date: 2026-07-22 19:31:47.108577
"""
...
def upgrade() -> None:
    ...
    sa.Column('requester_hash', sa.Text(), nullable=True),
    sa.Column('code_attempts', sa.Integer(), server_default='0', nullable=False),
    ...
    op.create_index(op.f('ix_magic_link_tokens_requester_hash'), 'magic_link_tokens', ['requester_hash'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_magic_link_tokens_requester_hash'), table_name='magic_link_tokens')
